...
void compute(const QUESO::FullEnvironment& env) {
  ...
  QUESO::GslVector meanVector1(paramSpace.zeroVector());
  meanVector1[0] = 0;
  meanVector1[1] = 0;
                                                         
  QUESO::GslVector meanVector2(paramSpace.zeroVector());
  meanVector2[0] = 4;
  meanVector2[1] = 4;
  ...
  likelihoodRoutine_Data.meanVector2 = &meanVector2;
  likelihoodRoutine_Data.meanVector3 = &meanVector3;
  likelihoodRoutine_Data.meanVector4 = &meanVector4;
